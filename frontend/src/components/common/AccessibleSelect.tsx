 ...
 *
 * Fully accessible select dropdown with validation
 */
...
export interface AccessibleSelectProps extends Omit<React.SelectHTMLAttributes<HTMLSelectElement>, 'aria-label'> {
  /**
  ...
  /**
   * Whether to hide label visually
   */
  hideLabel?: boolean;
